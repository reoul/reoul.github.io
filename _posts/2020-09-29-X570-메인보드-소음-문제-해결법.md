...
상단 메뉴 중 **H/W모니터** 를 클릭한다.

아래의 사진처럼 휠로 내리다 보면 맨 밑쪽에 **CPU_Fan2 and Chassis Fan Configuration** 이라는 항목을 클릭한다.

![UEFI1](/assets/img/2020-09-29-1.png)

아래의 사진처럼 휠로 내리다 보면 맨 밑쪽에 **SB_FAN1_Setting** 의 모드를 **무음 모드** 나 **표준 모드** 둘 중 하나 적용한다.

![UEFI2](/assets/img/2020-09-29-2.png)

메인보드 UEFI 설정을 저장하고 다시 부팅해본다.
